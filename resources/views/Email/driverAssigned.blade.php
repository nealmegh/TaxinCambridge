                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        >
                                            Dear {{$data['driver']->name}}, You have been assigned with a new Trip from TaxiInCambridge
                                    ...
                                    <td colspan="2">
                                        <table style="width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:70%;padding:15px 0;">
                                                    <p style="margin:0">{{$data['user']->name}}</p>
                                                    <p style="margin:0">{{$data['user']->phone}}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                            ...
                                            @endif
                                                <tr>
                                                    ...
                                                    <td style="width:70%;padding:15px 0;">
                                                        <p style="margin:0">
                                                            {{$data['booking']->airport->display_name}}
                                                        </p>
                                                        <p style="margin:0">
                                                            {{$data['booking']->location->display_name}}
                                                        </p>
                                                        @if($data['booking']->return == 1)
                                                            <p style="margin:0">Yes</p>
                                                        @else
