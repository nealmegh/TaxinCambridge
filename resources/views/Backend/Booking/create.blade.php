                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate method="POST" action="{{ route('booking.store') }}">
                            ...
                            <div class="item form-group" id="rPA"  style="display: none">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="return_pickup_address"> Return Pick Up Address <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="return_pickup_address" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="return_pickup_address" placeholder="Put Pickup Address" required="required" type="text" disabled>
                                </div>
                            </div>
                            <div class="item form-group" id="rDA" style="display: none">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="return_dropoff_address">Return Drop Off Address <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="return_dropoff_address" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="return_dropoff_address" placeholder="Put Drop Off Address" required="required" type="text" disabled>
                                </div>
                            </div>
