...
//        dd($request);
        ...
        return redirect()->route('locations')->with('message', 'Location Added');
    }
...
//            }
        ...
        return redirect()->route('locations')->with('message', 'Location Updated');
    }
    ...
    public function destroy(Request $request, $location)
    {
        ...
        return redirect()->route('locations')->with('message', 'Location Deleted');
    }
